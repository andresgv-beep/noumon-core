...
<style>
  ...
  .tagchip{display:inline-flex;align-items:center;gap:8px;padding:9px 12px;background:var(--card);border:1px solid var(--border);border-radius:var(--r-lg);color:var(--ink-dim);font-size:14px;box-shadow:var(--shadow);transition:background .12s,border-color .12s,color .12s}
  ...
  .tagchip .cnt{min-width:20px;height:20px;padding:0 6px;border-radius:var(--r-md);background:color-mix(in srgb,var(--accent) 20%,transparent);color:var(--accent-2);font-size:11.5px;font-weight:650;display:grid;place-items:center;font-variant-numeric:tabular-nums}
  ...
  .back{display:inline-flex;align-items:center;gap:6px;height:32px;padding:0 12px;border-radius:var(--r-md);background:var(--card);border:1px solid var(--border);color:var(--ink-dim);font-size:13px;transition:background .12s,color .12s}
  ...
  .hbtn{margin-left:auto;display:flex;align-items:center;gap:7px;height:32px;padding:0 12px;border-radius:var(--r-md);font-size:12.5px;color:var(--ink-dim);border:1px solid var(--border);background:var(--card);transition:background .12s,color .12s,border-color .12s}
  ...
  .row{display:flex;align-items:center;gap:6px;background:var(--card);border:1px solid var(--border);border-radius:var(--r-lg);box-shadow:var(--shadow);transition:border-color .12s,background .12s}
  ...
  .act{width:30px;height:30px;border-radius:var(--r-md);display:grid;place-items:center;color:var(--muted);opacity:0;transition:background .12s,color .12s,opacity .12s}
