...
<style>
  ...
  .notices-dialog{width:min(960px,100%);height:min(760px,calc(100vh - 56px));display:flex;flex-direction:column;overflow:hidden;border:1px solid var(--border);border-radius:var(--r-pill);background:var(--ground);box-shadow:0 24px 80px rgba(0,0,0,.45)}
